...
var reader = rd.createInterface(fs.createReadStream('./src/2018/day25/test2.txt'));
...
function checkSamePoint(point1: Position, point2: Position): boolean {
  return point1.x == point2.x && point1.y == point2.y && point1.z == point2.z && point1.r == point2.r;
}
...
function createCostellations(): Array<string> {
  ...
  points.forEach((element) => {
    ...
    if (!find && costellations.indexOf(hash) < 0) {
      //} && hash != undefined) {
